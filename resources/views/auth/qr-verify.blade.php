...
@section('content')
    ...
    <div class="background">
        <div class="container">
            ...
            <div class="fs-s"></div>
            <form action="{{ route('confirm-qr') }}" method="POST">
                @csrf
                @method('GET')
                <div class="form-group">
                    <label for="exampleInputPassword1">One-time QR password</label>
                    <input type="text" class="form-control" name="one_time_password" id="exampleInputPassword1" placeholder="Password">
